# Naive Mean Forecaster in Darts
...
- A **Naive Mean Forecaster** algorithm built using **Darts**
...
<<<<<<< HEAD
This project is provided under the Apache License-2.0 License. Please see the [LICENSE](LICENSE) file for more information.
=======
This project is provided under the Apache 2.0 License. Please see the [LICENSE](LICENSE) file for more information.
>>>>>>> 49f820dcfcdbd8221f28b754d82445404685aad0
